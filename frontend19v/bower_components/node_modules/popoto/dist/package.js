...
export var dependencies = {"d3":"^5.7.0","jquery":"^3.3.1"};
export var devDependencies = {"babel-core":"^6.26.3","babel-jest":"^23.6.0","babel-plugin-transform-es2015-modules-commonjs":"^6.26.2","jest":"^23.6.0","jest-canvas-mock":"^1.1.0","json2module":"^0.0.3","rimraf":"^2.6.2","rollup":"^0.67.1","rollup-plugin-copy":"^0.2.3","rollup-plugin-node-resolve":"^3.4.0","uglify-js":"^3.4.9","uglifycss":"^0.0.29"};
