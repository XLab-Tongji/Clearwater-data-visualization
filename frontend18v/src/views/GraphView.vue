...
<script>
    ...
    export default {
        ...
        methods: {
            labelClick(labelName) {
                ...
                if (labelName == 'All_Nodes') {
                    baseURL = 'http://10.60.38.182:9999/bbs/api/getAll'
                } else {
                    baseURL = 'http://10.60.38.182:9999/bbs/api/getLabel?label=' + labelName;
                }
                axios.get(baseURL)
                    .then((response) => {
        ...
        mounted() {
            ...
            axios.get('http://10.60.38.182:9999/bbs/api/getAll')
                .then((response) => {
