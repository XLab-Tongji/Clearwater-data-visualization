...
function initAll() {
    $(document).ready(function () {
        ...
        //     url: 'http://10.60.38.182:9999/bbs/api/getCSV',
        //     // type: "GET",
        //     // crossDomain: true,
        //     success: function (fb_data) {
        //         let CSV = fb_data.CSV;
        //         for(var i = 0; i < CSV.length; i++) {
        //             addOption('file', i, CSV[i])
        //         }
        //     },
        //     error: function (msg) {
        //         alert('error');
        ...
        $('#submit_btn').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (fb_data) {
                    ...
                    if (fb_data.message == 'Success' && fb_data.code == 200) {
                        ...
                        //////
                        uploadData = analysis_result.text
                    }
            ...
            //
            //             formData = new FormData();
            //             formData.append('string', fb_data.data);
            //
            //             $.ajax({
            //                 // url: 'http://10.60.38.182:10080/search/' + $('#select')[0].value,
            //                 url: 'http://10.60.38.182:10080/' + "causality",
...
function addOption(selectEleId, optionValue, optionInnerHTML) {
