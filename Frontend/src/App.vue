    ...
    <el-container class="whole">
      <el-container style="width:80%;">
        <el-header height="20%">
          <el-row>
            <el-col :span="10">
              <el-input placeholder="Please keywords to search for specific resource" prefix-icon="el-icon-search"
                v-model="keyword">
              </el-input>
            </el-col>
            <el-col :span="4">
          ...
          <el-row>
            ...
            <el-col :offset="2" :span="9">
              <label style="color:white; display: block;"><input style="width:240px; margin-top: 20pt;" type="range"
                  min="0" max="0.2" step="any" value="0.1"> Link Strength</label>
            </el-col>
          </el-row>
        </el-header>
        <el-main>
          ...
          <el-row>
            ...
            <div id="neo4jd3" width="1000" height="500" style="background:white"></div>
                ...
                <el-form label-position="top" style="text-align:left">
                  ...
                  <el-form-item label="Failure Type">
                    <el-select v-model="newFailure.type" placeholder="Choose failure type" size="medium" style="display:inline">
                      <el-option v-for="item in ['Fail slow', 'Fail partial', 'Fail stop', 'Fail transient', 'Fail as well as corruption']"
                        :key="item" :value="item">
                      </el-option>
                    </el-select>
                  </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      new Neo4JD3('#neo4jd3', {
        // neo4jData: data,
        neo4jDataUrl: './assets/neo4jData.json',
        minCollision: 75,
        nodeRadius: 20
      })
    }
