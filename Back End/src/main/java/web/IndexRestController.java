...
//    @ResponseBody
    ...
    //处理yaml文件接口
    public ArrayList yamldeal(@RequestParam("file") MultipartFile file,@RequestParam("systemName") String system) {
        Yaml yaml = new Yaml();
...
//        String performance = (String)map.get("performance");
    ...
    public HashMap addMetric(HttpServletRequest request, HttpServletResponse response, @RequestParam("Type") String type,@RequestParam("pod") String podName,
        ...
        return AddMetricNode(type,podName,metricName,datasetName,relationName);
    }
